    ...
    <>
      ...
      >
        ...
        <div className="p-5 pt-5 pb-5">
          ...
          <button onClick={() => setPickerOpen(true)} className="w-full flex items-center justify-between gap-3 bg-gray-50 hover:bg-gray-100 rounded-xl px-2 py-1.5 -mx-2 transition-colors">
